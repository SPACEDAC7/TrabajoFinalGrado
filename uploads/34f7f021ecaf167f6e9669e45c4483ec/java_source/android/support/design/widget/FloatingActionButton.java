...
extends VisibilityAwareImageButton {
    ...
    private int getSizeDimension(int n2) {
    ...
    protected void onMeasure(int n2, int n3) {
        ...
        this.mImagePadding = (n4 - this.mMaxImageSize) / 2;
    ...
    extends CoordinatorLayout.Behavior<FloatingActionButton> {
        ...
        private void offsetIfNeeded(CoordinatorLayout coordinatorLayout, FloatingActionButton floatingActionButton) {
            ...
            if (rect != null && rect.centerX() > 0 && rect.centerY() > 0) {
                ...
                if (n2 != 0) {
                    ViewCompat.offsetTopAndBottom((View)floatingActionButton, n2);
                }
                if (n3 != 0) {
                    ViewCompat.offsetLeftAndRight((View)floatingActionButton, n3);
                }
            }
        }
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, FloatingActionButton floatingActionButton, int n2) {
            ...
            for (int i2 = 0; i2 < n3; ++i2) {
                ...
                if (view instanceof AppBarLayout) {
                    if (!this.updateFabVisibilityForAppBarLayout(coordinatorLayout, (AppBarLayout)view, floatingActionButton)) continue;
                    break;
                }
                if (Behavior.isBottomSheet(view) && this.updateFabVisibilityForBottomSheet(view, floatingActionButton)) break;
            }
