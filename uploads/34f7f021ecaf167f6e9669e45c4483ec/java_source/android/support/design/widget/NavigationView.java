...
extends ScrimInsetsFrameLayout {
    ...
    public NavigationView(Context context, AttributeSet attributeSet, int n2) {
        ...
        TintTypedArray tintTypedArray = TintTypedArray.obtainStyledAttributes(context, attributeSet, R.styleable.NavigationView, n2, R.style.Widget_Design_NavigationView);
    ...
    protected void onMeasure(int n2, int n3) {
        ...
        switch (View.MeasureSpec.getMode((int)n2)) {
            ...
            case Integer.MIN_VALUE: {
                n4 = View.MeasureSpec.makeMeasureSpec((int)Math.min(View.MeasureSpec.getSize((int)n2), this.mMaxWidth), (int)1073741824);
            }
            case 1073741824: {
                break;
            }
