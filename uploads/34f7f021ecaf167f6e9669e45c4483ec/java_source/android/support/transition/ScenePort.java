...
final class ScenePort {
    ...
    private ScenePort(ViewGroup viewGroup, int n2, Context context) {
    ...
    public static ScenePort getSceneForLayout(ViewGroup viewGroup, int n2, Context context) {
        return new ScenePort(viewGroup, n2, context);
    }
