...
class TransitionManagerPort {
    ...
    static ArrayMap<ViewGroup, ArrayList<TransitionPort>> getRunningTransitions() {
        ...
        if (weakReference != null) {
            WeakReference<ArrayMap<ViewGroup, ArrayList<TransitionPort>>> weakReference2 = weakReference;
            if (weakReference.get() != null) return (ArrayMap)var0_3.get();
        }
        WeakReference weakReference3 = new WeakReference(new ArrayMap());
        sRunningTransitions.set(weakReference3);
        return (ArrayMap)var0_3.get();
    }
    ...
    public String[] getTargetSceneNames(ScenePort arrstring) {
        ...
        do {
            ...
            arrstring2[n3] = arrayMap.keyAt(n3);
            ++n3;
        } while (true);
    }
