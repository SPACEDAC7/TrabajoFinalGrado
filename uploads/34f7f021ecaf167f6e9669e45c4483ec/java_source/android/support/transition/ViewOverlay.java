...
class ViewOverlay {
    ...
    extends ViewGroup {
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            if (this.mDrawables != null) {
                n2 = this.mDrawables.size();
            }
            int n3 = 0;
            while (n3 < n2) {
                this.mDrawables.get(n3).draw(canvas);
                ++n3;
            }
        }
        ...
        public void invalidateChildFast(View arrn, Rect rect) {
            if (this.mHostView != null) {
                ...
                arrn = new int[2];
                this.getOffset(arrn);
                rect.offset(arrn[0] + n2, arrn[1] + n3);
        ...
        protected ViewParent invalidateChildInParentFast(int n2, int n3, Rect rect) {
            ...
            try {
                ...
                sInvalidateChildInParentFastMethod.invoke((Object)this.mHostView, new Object[]{n2, n3, rect});
                return null;
            }
