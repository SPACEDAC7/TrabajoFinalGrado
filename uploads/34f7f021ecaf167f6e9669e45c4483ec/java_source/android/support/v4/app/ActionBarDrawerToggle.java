...
implements DrawerLayout.DrawerListener {
    ...
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, @DrawableRes int n2, @StringRes int n3, @StringRes int n4) {
        ...
        this(activity, drawerLayout, bl, n2, n3, n4);
    }

    /*
     * Enabled aggressive block sorting
     */
    public ActionBarDrawerToggle(Activity object, DrawerLayout drawerLayout, boolean bl, @DrawableRes int n2, @StringRes int n3, @StringRes int n4) {
