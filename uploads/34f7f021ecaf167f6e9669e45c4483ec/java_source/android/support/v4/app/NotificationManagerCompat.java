...
public final class NotificationManagerCompat {
    ...
    public static Set<String> getEnabledListenerPackages(Context object) {
        ...
        synchronized (object) {
            ...
            do {
                if (n3 < n2) {
                    ComponentName componentName = ComponentName.unflattenFromString((String)arrstring[n3]);
    ...
    ServiceConnection {
        ...
        private boolean ensureServiceBound(ListenerRecord listenerRecord) {
            ...
            listenerRecord.bound = this.mContext.bindService(intent, (ServiceConnection)this, NotificationManagerCompat.SIDE_CHANNEL_BIND_FLAGS);
            if (listenerRecord.bound) {
