...
class MediaBrowserServiceCompatApi24 {
    ...
    static {
        try {
            ...
            Log.w((String)"MBSCompatApi24", (Throwable)var0);
        }
    }
    ...
    static class ResultWrapper {
         ...
         */
        public void sendResult(List<Parcel> list, int n2) {
            try {
                sResultFlags.setInt((Object)this.mResultObj, n2);
            }
            catch (IllegalAccessException var3_3) {
                Log.w((String)"MBSCompatApi24", (Throwable)var3_3);
            }
