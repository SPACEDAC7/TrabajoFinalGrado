...
public final class AsyncLayoutInflater {
    ...
    @UiThread
    public void inflate(@LayoutRes int n2, @Nullable ViewGroup viewGroup, @NonNull OnInflateFinishedListener onInflateFinishedListener) {
        if (onInflateFinishedListener == null) {
            throw new NullPointerException("callback argument may not be null!");
        }
        InflateRequest inflateRequest = this.mInflateThread.obtainRequest();
        inflateRequest.inflater = this;
        inflateRequest.resid = n2;
    ...
    extends Thread {
        ...
        public void enqueue(InflateRequest inflateRequest) {
            try {
                ...
                throw new RuntimeException("Failed to enqueue async inflate request", var1_2);
            }
        }
        ...
        public void run() {
            do {
                ...
                try {
                    ...
                    Log.w((String)"AsyncLayoutInflater", (Throwable)var1_2);
                    continue;
                }
                try {
                    ...
                    Log.w((String)"AsyncLayoutInflater", (String)"Failed to inflate resource in the background! Retrying on the UI thread", (Throwable)var2_3);
                }
