...
public final class MotionEventCompat {
    ...
    static final MotionEventVersionImpl IMPL = Build.VERSION.SDK_INT >= 14 ? new ICSMotionEventVersionImpl() : (Build.VERSION.SDK_INT >= 12 ? new HoneycombMr1MotionEventVersionImpl() : new BaseMotionEventVersionImpl());
    ...
    public static boolean isFromSource(MotionEvent motionEvent, int n2) {
        if ((motionEvent.getSource() & n2) == n2) {
            return true;
        }
        return false;
    }
    ...
    extends HoneycombMr1MotionEventVersionImpl {
