...
public final class ViewParentCompat {
    ...
    public static boolean onNestedFling(ViewParent viewParent, View view, float f2, float f3, boolean bl) {
        return IMPL.onNestedFling(viewParent, view, f2, f3, bl);
    }
    ...
    extends ViewParentCompatKitKatImpl {
        ...
        @Override
        public boolean onNestedFling(ViewParent viewParent, View view, float f2, float f3, boolean bl) {
            return ViewParentCompatLollipop.onNestedFling(viewParent, view, f2, f3, bl);
        }
    ...
    implements ViewParentCompatImpl {
        ...
        public boolean onNestedFling(ViewParent viewParent, View view, float f2, float f3, boolean bl) {
            if (viewParent instanceof NestedScrollingParent) {
                return ((NestedScrollingParent)viewParent).onNestedFling(view, f2, f3, bl);
            }
            return false;
        }
