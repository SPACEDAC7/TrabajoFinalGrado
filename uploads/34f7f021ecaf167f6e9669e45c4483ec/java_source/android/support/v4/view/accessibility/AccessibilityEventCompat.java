...
public final class AccessibilityEventCompat {
    ...
    public void setAction(AccessibilityEvent accessibilityEvent, int n2) {
        IMPL.setAction(accessibilityEvent, n2);
    }

    public void setMovementGranularity(AccessibilityEvent accessibilityEvent, int n2) {
        IMPL.setMovementGranularity(accessibilityEvent, n2);
    }
    ...
    extends AccessibilityEventIcsImpl {
        ...
        @Override
        public void setAction(AccessibilityEvent accessibilityEvent, int n2) {
            AccessibilityEventCompatJellyBean.setAction(accessibilityEvent, n2);
        }

        @Override
        public void setMovementGranularity(AccessibilityEvent accessibilityEvent, int n2) {
            AccessibilityEventCompatJellyBean.setMovementGranularity(accessibilityEvent, n2);
        }
    }
