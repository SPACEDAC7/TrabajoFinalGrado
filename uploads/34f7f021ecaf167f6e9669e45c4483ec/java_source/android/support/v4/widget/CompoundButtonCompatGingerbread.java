    ...
    static Drawable getButtonDrawable(CompoundButton compoundButton) {
        if (!sButtonDrawableFieldFetched) {
            try {
                ...
                Log.i((String)"CompoundButtonCompatGingerbread", (String)"Failed to retrieve mButtonDrawable field", (Throwable)var1_2);
            }
        ...
        try {
            ...
            Log.i((String)"CompoundButtonCompatGingerbread", (String)"Failed to get button drawable via reflection", (Throwable)var0_1);
