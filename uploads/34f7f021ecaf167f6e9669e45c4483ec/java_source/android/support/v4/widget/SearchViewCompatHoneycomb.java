...
class SearchViewCompatHoneycomb {
    ...
    public static void setOnCloseListener(View view, Object object) {
        ((SearchView)view).setOnCloseListener((SearchView.OnCloseListener)object);
    }

    public static void setOnQueryTextListener(View view, Object object) {
        ((SearchView)view).setOnQueryTextListener((SearchView.OnQueryTextListener)object);
    }
