...
implements Menu {
    ...
    public void setGroupCheckable(int n2, boolean bl, boolean bl2) {
        ((SupportMenu)this.mWrappedObject).setGroupCheckable(n2, bl, bl2);
    }

    public void setGroupEnabled(int n2, boolean bl) {
        ((SupportMenu)this.mWrappedObject).setGroupEnabled(n2, bl);
    }

    public void setGroupVisible(int n2, boolean bl) {
        ((SupportMenu)this.mWrappedObject).setGroupVisible(n2, bl);
    }
