...
class AppCompatCompoundButtonHelper {
    ...
    void loadFromAttributes(AttributeSet attributeSet, int n2) {
        attributeSet = this.mView.getContext().obtainStyledAttributes(attributeSet, R.styleable.CompoundButton, n2, 0);
        try {
            if (attributeSet.hasValue(R.styleable.CompoundButton_android_button) && (n2 = attributeSet.getResourceId(R.styleable.CompoundButton_android_button, 0)) != 0) {
                this.mView.setButtonDrawable(AppCompatResources.getDrawable(this.mView.getContext(), n2));
            }
