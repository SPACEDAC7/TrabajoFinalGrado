...
public class PopupMenu {
    ...
    public PopupMenu(@NonNull Context context, @NonNull View view, int n2) {
        this(context, view, n2, R.attr.popupMenuStyle, 0);
    }

    public PopupMenu(@NonNull Context context, @NonNull View view, int n2, @AttrRes int n3, @StyleRes int n4) {
