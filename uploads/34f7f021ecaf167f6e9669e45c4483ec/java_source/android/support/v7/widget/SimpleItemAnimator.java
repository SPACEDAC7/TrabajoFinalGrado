...
extends RecyclerView.ItemAnimator {
    ...
    public boolean animateChange(@NonNull RecyclerView.ViewHolder viewHolder, @NonNull RecyclerView.ViewHolder viewHolder2, @NonNull RecyclerView.ItemAnimator.ItemHolderInfo itemHolderInfo, @NonNull RecyclerView.ItemAnimator.ItemHolderInfo itemHolderInfo2) {
        int n2;
        int n3;
        int n4 = itemHolderInfo.left;
        int n5 = itemHolderInfo.top;
        if (viewHolder2.shouldIgnore()) {
            n3 = itemHolderInfo.left;
            n2 = itemHolderInfo.top;
            do {
                return this.animateChange(viewHolder, viewHolder2, n4, n5, n3, n2);
                break;
            } while (true);
        }
        n3 = itemHolderInfo2.left;
    ...
    public boolean animateDisappearance(@NonNull RecyclerView.ViewHolder viewHolder, @NonNull RecyclerView.ItemAnimator.ItemHolderInfo itemHolderInfo, @Nullable RecyclerView.ItemAnimator.ItemHolderInfo itemHolderInfo2) {
        int n2 = itemHolderInfo.left;
        int n3 = itemHolderInfo.top;
        itemHolderInfo = viewHolder.itemView;
        int n4 = itemHolderInfo2 == null ? itemHolderInfo.getLeft() : itemHolderInfo2.left;
        int n5 = itemHolderInfo2 == null ? itemHolderInfo.getTop() : itemHolderInfo2.top;
        if (!(viewHolder.isRemoved() || n2 == n4 && n3 == n5)) {
            itemHolderInfo.layout(n4, n5, itemHolderInfo.getWidth() + n4, itemHolderInfo.getHeight() + n5);
