...
implements View.OnClickListener {
    ...
    private Drawable getActivityIcon(ComponentName componentName) {
        ...
        packageManager = activityInfo = packageManager.getDrawable(componentName.getPackageName(), n2, activityInfo.applicationInfo);
...
lbl29: // 1 sources:
    ...
    public View getView(int n2, View view, ViewGroup viewGroup) {
        try {
            ...
            Log.w((String)"SuggestionsAdapter", (String)"Search suggestions cursor threw exception.", (Throwable)var4_4);
            view = viewGroup = this.newView(this.mContext, this.mCursor, viewGroup);
            if (viewGroup == null) return view;
            ((ChildViewCache)viewGroup.getTag()).mText1.setText((CharSequence)var4_4.toString());
            return viewGroup;
        }
    }
