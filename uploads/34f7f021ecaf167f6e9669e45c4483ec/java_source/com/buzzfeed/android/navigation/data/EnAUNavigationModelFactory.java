...
public class EnAUNavigationModelFactory
extends EnNavigationModelFactory {
    @Nullable
    @Override
    protected String[] buildExploreFeedTags() {
        return new String[]{"animals", "bigstories", "books", "buzz", "celebrity", "community", "cute", "diy", "entertainment", "food", "health", "lgbt", "life", "lol", "music", "parents", "politics", "rewind", "science", "style", "tech", "travel", "weddings", "win", "world"};
    }
