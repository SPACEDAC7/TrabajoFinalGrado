...
public class EnUKNavigationModelFactory
extends EnNavigationModelFactory {
    ...
    protected void initializeAdditionalFeeds(@NonNull List<Feed> list) {
        ...
        list.add(new Feed.Builder("politics").withUri("ukpolitics").withDisplayName("Politics").withLocalizedNameResourceId(2131296886).withWidgetImageUri("https://s3-ak.buzzfeed.com/static/badge_images/widget_politics.png").build());
