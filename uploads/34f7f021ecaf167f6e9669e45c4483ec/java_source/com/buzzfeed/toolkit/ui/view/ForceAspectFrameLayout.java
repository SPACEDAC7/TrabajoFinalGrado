...
public class ForceAspectFrameLayout
extends FrameLayout {
    private float aspectRatio = 0.0f;

    public ForceAspectFrameLayout(Context context) {
        this(context, null);
    }

    public ForceAspectFrameLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public ForceAspectFrameLayout(Context context, AttributeSet attributeSet, int n2) {
