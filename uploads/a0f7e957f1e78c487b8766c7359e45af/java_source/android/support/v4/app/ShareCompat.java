...
public class ShareCompat {
    ...
    public static void configureMenuItem(Menu menu2, int n2, IntentBuilder intentBuilder) {
        if ((menu2 = menu2.findItem(n2)) == null) {
    ...
    public static class IntentBuilder {
        ...
        private void combineArrayExtra(String string2, ArrayList<String> arrayList) {
            ...
            String[] arrstring2 = new String[arrayList.size() + n2];
            arrayList.toArray(arrstring2);
            if (arrstring != null) {
                System.arraycopy(arrstring, 0, arrstring2, arrayList.size(), n2);
            }
        ...
        private void combineArrayExtra(String string2, String[] arrstring) {
            ...
            if (arrstring2 != null) {
                System.arraycopy(arrstring2, 0, arrstring3, 0, n2);
            }
            System.arraycopy(arrstring, 0, arrstring3, n2, arrstring.length);
