    ...
    public static Object newAccessibilityDelegateBridge(final AccessibilityDelegateBridgeJellyBean accessibilityDelegateBridgeJellyBean) {
        return new View.AccessibilityDelegate(){
            ...
            public boolean performAccessibilityAction(View view, int n2, Bundle bundle) {
                return accessibilityDelegateBridgeJellyBean.performAccessibilityAction(view, n2, bundle);
            }

            public void sendAccessibilityEvent(View view, int n2) {
                accessibilityDelegateBridgeJellyBean.sendAccessibilityEvent(view, n2);
            }
